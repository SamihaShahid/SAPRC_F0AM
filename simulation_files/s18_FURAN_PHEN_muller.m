...
ChemFiles = {...
    ...
    'SAPRC18_AllRxns_FURNS_removed_FURAN';
...
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/conc.xlsx');

time_data = num2cell(S.Time);
time_data=cell2table(time_data,"VariableNames",["t"]);
writetable(time_data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/t.xlsx');

data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/rnames.xlsx');

data = num2cell(S.Chem.Rates);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/rates.xlsx');

data = num2cell(S.Chem.f);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/f.xlsx');

data = num2cell(S.Chem.k);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/k.xlsx');

data = num2cell(S.Chem.iG);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_5_S18_FURAN_PHEN/iG.xlsx');
